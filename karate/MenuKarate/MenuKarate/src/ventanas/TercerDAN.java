...
import ClasesdeRepuesto.extercerdam;
 ...
 * @author wesle
 */
public class TercerDAN extends javax.swing.JFrame {
  ...
  Interface Ventana = new Interface();
   ...
   Ventana.setVisible(true);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Examen Tercer DAN"));
    ...
    private void terminarExamenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_terminarExamenActionPerformed
        ...
        try {
            ...
            Logger.getLogger(extercerdam.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TercerDAN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
