...
import ClasesdeRepuesto.exsegundodam;
...
public class SegundoDAN extends javax.swing.JFrame {
  ...
  Interface Ventana = new Interface();
   ...
   Ventana.setVisible(true);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Examen Segundo DAN"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SegundoDAN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SegundoDAN().setVisible(true);
            }
        });
    }
